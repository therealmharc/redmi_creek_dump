...
cat vendor_boot/dtb/24_dtbdump_Qualcomm_Technologies,_Inc._Scubap_IOT_SoC.dtb.* 2>/dev/null >> vendor_boot/dtb/24_dtbdump_Qualcomm_Technologies,_Inc._Scubap_IOT_SoC.dtb
rm -f vendor_boot/dtb/24_dtbdump_Qualcomm_Technologies,_Inc._Scubap_IOT_SoC.dtb.* 2>/dev/null
